...
export default function Cookies() {
    return (
        <div>
            <h1>Cookie Policy for Weeb WHeel</h1>

            <p>
                This is the Cookie Policy for Weeb WHeel, accessible from
                https://mob-atheist.github.io/Weeb-Wheel/
            </p>
